"""Regression checks for the plume-dev-formatter-meter casebook."""
...
from casebook.harness import assert_expected, plume_dev_formatter_meter_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_dev_formatter_meter_summary(), assert_expected())
